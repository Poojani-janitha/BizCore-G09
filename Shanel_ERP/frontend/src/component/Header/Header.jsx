...
const Header = () => {
    ...
    const getPageTitle = () => {
        ...
        if (path === '/hr') return t('header.hr', 'HR Dashboard');
        if (path.includes('/hr/employees')) return t('header.employees', 'Employees');
        if (path.includes('/hr/attendance')) return t('header.attendance', 'Daily Attendance');
        if (path.includes('/hr/payroll')) return t('header.payroll', 'Payroll Management');
        if (path.includes('/hr/reports')) return t('header.reports', 'HR Reports');
        if (path.includes('/hr/leave')) return  t('header.leave', 'Leave Details');
        ...
        if (path === '/sales') return t('sales.dashboard_title', 'Sales Dashboard');
        if (path === '/sales/history') return t('sales.history_title', 'Sales History');
        if (path === '/sales/customers') return t('sales.customers_title', 'Customer List');
        if (path.includes('/sales/customers/')) return t('sales.customer_detail_title', 'Customer Detail');
        if (path === '/sales/cheques') return t('sales.cheques_title', 'Cheque Management');
        if (path === '/sales/due') return t('sales.due_sales_title', 'Due Sales');
        if (path === '/sales/reports') return t('sales.reports_title', 'Sales Reports');
