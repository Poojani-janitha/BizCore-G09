...
const QuickActions = () => {
  ...
  const actions = [
    ...
    { label: 'Approve Leave', icon: '✅', color: '#f59e0b', bg: 'rgba(245,158,11,0.08)' , path: '/hr/leave' },
    { label: 'Send Paysheet', icon: '📧', color: '#ef4444', bg: 'rgba(239,68,68,0.08)', path: '/hr/payroll' },
