        ...
        if (show) {
            ...
            if (editData) {
                ...
                setFormData({
                    ...
                    Min_Stock: editData.minStock != null ? parseFloat(editData.minStock) : 0,
                    Reorder_Level: editData.reorderLevel != null && editData.reorderLevel !== '' ? parseFloat(editData.reorderLevel) : '',
                    ...
                    InitialQty: (editData.type === 'Other' || editData.type === 'Raw' || editData.isIsharaProduct) ? (editData.stockCount != null ? parseFloat(editData.stockCount) : 0) : 0,
                                ...
                                <div className="row g-2">
                                    ...
                                    <div className="col-12 mb-2">
                                        ...
                                        <input
                                            type="text"
                                            name="P_Code"
                                            className="form-control form-control-sm py-2 shadow-none"
                                            value={formData.P_Code}
                                            readOnly
                                            style={{ backgroundColor: '#e2e8f0', border: '1px solid #cbd5e1', cursor: 'not-allowed', opacity: 0.8 }}
                                        />
                                    </div>
                                    ...
                                    <div className="col-12 mb-2">
                                        ...
                                        <input type="text" name="P_Name" className={`form-control form-control-sm py-2 shadow-none ${errors.P_Name ? 'border border-danger' : ''}`}
                                    ...
                                    <div className="col-12 mb-2">
                                        ...
                                        <input type="text" name="P_Name_Sinhala" className="form-control form-control-sm py-2 shadow-none"
                                            style={{ backgroundColor: '#f1f5f9', border: '1px solid #cbd5e1' }}
                                    ...
                                    <div className="col-6 mb-2">
                                        ...
                                        <select name="P_Type" className="form-select form-select-sm py-2 shadow-none"
                                            style={{ backgroundColor: '#e2e8f0', border: '1px solid #cbd5e1', borderRadius: '8px', cursor: 'not-allowed' }}
                                    ...
                                    <div className="col-4">
                                        ...
                                        <input type="number" step="0.01" min="0" name="Cost_Price" className={`form-control form-control-sm py-2 ${errors.Cost_Price ? 'border border-danger' : ''}`}
                                            style={{ backgroundColor: '#f1f5f9', border: '1px solid #cbd5e1' }}
                                    ...
                                    <div className="col-4">
                                        ...
                                        <input type="number" step="0.01" min="0" name="Retail_Price" className={`form-control form-control-sm py-2 ${errors.Retail_Price ? 'border border-danger' : ''}`}
                                            style={{ backgroundColor: '#f1f5f9', border: '1px solid #cbd5e1' }}
                                    ...
                                    <div className="col-4">
                                        ...
                                        <input type="number" step="0.01" min="0" name="Wholesale_Price" className={`form-control form-control-sm py-2 ${errors.Wholesale_Price ? 'border border-danger' : ''}`}
                                            style={{ backgroundColor: '#f1f5f9', border: '1px solid #cbd5e1' }}
                                    ...
                                    <div className="col-6 mt-2">
                                        ...
                                        <input type="number" step="0.01" min="0" name="Tax_Rate" className={`form-control form-control-sm py-2 ${errors.Tax_Rate ? 'border border-danger' : ''}`}
                                            style={{ backgroundColor: '#f1f5f9', border: '1px solid #cbd5e1' }}
                                    ...
                                    <div className="col-6 mt-2">
                                        ...
                                        <input type="number" step="any" min="0" name="Min_Stock" className={`form-control form-control-sm py-2 ${errors.Min_Stock ? 'border border-danger' : ''}`}
                                            style={{ backgroundColor: '#f1f5f9', border: '1px solid #cbd5e1' }}
                                    ...
                                    {(formData.P_Type === 'Other' || formData.P_Type === 'Raw') && (
                                        <div className="col-12 mt-2 border-top pt-2">
                                            ...
                                            <select
                                                name="supplierId"
                                                className="form-select form-select-sm py-2 shadow-none"
                                                style={{ backgroundColor: '#f1f5f9', border: '1px solid #cbd5e1' }}
                                        ...
                                        <div className="col-6 mt-2">
                                            ...
                                            <div className="d-flex align-items-center" style={{ gap: '8px' }}>
                                                <input
                                                    ...
                                                    min="0"
                                                    name="InitialQty"
                                                    className={`form-control form-control-sm py-2 flex-grow-1 ${errors.InitialQty ? 'border border-danger' : ''}`}
                                                    style={{ backgroundColor: '#f1f5f9', border: '1px solid #cbd5e1' }}
                                    ...
                                    <div className="col-12 mt-2">
                                        ...
                                        <input type="number" step="any" min="0" name="Reorder_Level" className={`form-control form-control-sm py-2 ${errors.Reorder_Level ? 'border border-danger' : ''}`}
                                            style={{ backgroundColor: '#f1f5f9', border: '1px solid #cbd5e1' }}
                                    ...
                                    <div className="col-12 mt-2">
                                        ...
                                        <textarea name="Description" className="form-control form-control-sm py-2 shadow-none"
                                            style={{ backgroundColor: '#f1f5f9', border: '1px solid #cbd5e1' }}
                                            ...
                                            <>
                                                <div className="d-flex align-items-center" style={{ gap: '12px', marginBottom: '10px' }}>
                                                    <input
                                                        type="text"
                                                        name="Barcode"
                                                        className={`form-control py-2 shadow-none flex-grow-1 ${errors.Barcode ? 'border border-danger' : ''}`}
                                                        style={{ backgroundColor: '#f1f5f9', border: '1px solid #cbd5e1', borderRadius: '8px', fontSize: '14px', height: '42px' }}
                                                        value={formData.Barcode}
                                                        onChange={handleChange}
